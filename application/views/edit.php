	...
	<body>
	    ...
	    <div class="container">
	    	...
	    	<div class='row'>
	    		<div class = 'col-md-6'>
			    	<fieldset class="scheduler-border">
				        ...
				        <form class="form-signin" action="/users/edit_info/<?=$user_info['user_id']?>" method="post">
					        ...
					        <button class="btn btn-lg btn-primary pull-right" type="submit">Update Info</button>
					    </form>
				    </fieldset>
				</div>
				...
				<div class = 'col-md-5'>
				    <fieldset class="scheduler-border">
			    		...
			    		<form class="form-signin" action="/users/edit_password/<?=$user_info['user_id']?>" method="post">
					        ...
					        <input name="user_id" type="hidden" value="<?=$user_info['user_id']?>"/>
					        <button class="btn btn-lg btn-primary pull-right" type="submit">Change Password</button>
					    </form>
			      	</fieldset>
		        </div>
		    </div>
		    <div class='row'>
		    	<div class = 'col-md-12'>
			    	<fieldset class="scheduler-border">
			    		<legend class="scheduler-border">Edit Description</legend>
			    		<form class="form-signin full" action="/users/edit_description/<?=$user_info['user_id']?>" method="post">
		    				<textarea class="form-control" rows="4" name="description"><?=$user_info['description']?></textarea>
		    				<input name="user_id" type="hidden" value="<?=$user_info['user_id']?>"/>
			    			<button class="btn btn-lg btn-primary pull-right" type="submit">Update Description</button>
			    		</form>
			    	</fieldset>
		    	</div>
		    </div>
